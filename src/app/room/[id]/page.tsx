        ...
        <div className="max-w-md mx-auto flex items-center justify-center gap-1">
          ...
          {isInVoice ? (
            <>
              <button
                onClick={toggleMute}
                className="inline-flex items-center gap-1.5 text-sm hover:text-text-primary transition-colors px-3 py-2 rounded-lg"
                style={{
                  color: isMuted ? 'var(--color-rose-muted)' : 'var(--color-text-secondary)',
                  background: isMuted ? 'rgba(201, 123, 123, 0.06)' : 'transparent',
                }}
              ...
              <button
                onClick={leaveVoice}
                className="inline-flex items-center gap-1.5 text-text-muted text-sm hover:text-rose-muted transition-colors px-3 py-2 rounded-lg hover:bg-rose-soft/30"
                title="通話を退出"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.12 4.11 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.81.36 1.6.7 2.36a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.76.34 1.55.57 2.36.7a2 2 0 0 1 1.72 2z" />
                  <line x1="1" y1="1" x2="23" y2="23" />
                </svg>
